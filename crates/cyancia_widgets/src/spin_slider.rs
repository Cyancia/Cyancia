...
/// }
/// ```
pub struct SpinSlider<'a, T, Message, Theme, Renderer>
where
    Theme: Catalog,
...
impl<'a, T, Message, Theme, Renderer> SpinSlider<'a, T, Message, Theme, Renderer>
where
...
{
    fn from(
        slider: SpinSlider<'a, T, Message, Theme, Renderer>,
